# 使用前必读<a name="ZH-CN_TOPIC_0171442213"></a>
...
视频直播服务提供了REST（Representational State Transfer）风格API，支持您通过HTTPS请求调用，调用方法请参见[如何调用 API](https://support.huaweicloud.com/api-live/topic_live_04_overview_100003.html)。
