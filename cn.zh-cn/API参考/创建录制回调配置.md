# 创建录制回调配置<a name="CreateRecordCallbackConfig"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=CreateRecordCallbackConfig)中调试该接口。

## URI

POST /v1/\{project\_id\}/record/callbacks
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>创建配置操作成功</p>
</td>
</tr>
