# 创建录制规则<a name="CreateRecordRule"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=CreateRecordRule)中调试该接口。

## URI

POST /v1/\{project\_id\}/record/rules
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>创建录制规则操作成功</p>
</td>
</tr>
<tr><td class="cellrowborder" valign="top" width="15%" headers="mcps1.1.3.1.1 "><p>400</p>
</td>
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>创建录制规则操作失败</p>
</td>
</tr>
</tbody>
</table>
