...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>录制格式flv，hls，mp4，默认flv（目前仅支持flv）</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>录制位置vod， 默认vod（目前暂只支持vod）</p>
</td>
</tr>
