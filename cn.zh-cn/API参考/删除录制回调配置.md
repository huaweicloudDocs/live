# 删除录制回调配置<a name="DeleteRecordCallbackConfig"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=DeleteRecordCallbackConfig)中调试该接口。

## URI

DELETE /v1/\{project\_id\}/record/callbacks/\{id\}
...
```
DELETE https://{endpoint}/v1/{project_id}/record/callback/e89b76xxxxxx3425ui80af501cdxxxxxx
```
