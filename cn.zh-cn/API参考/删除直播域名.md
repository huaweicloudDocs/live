...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=DeleteDomain)中调试该接口。

## URI

DELETE /v1/\{project\_id\}/domain
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>直播域名删除成功</p>
</td>
</tr>
<tr><td class="cellrowborder" valign="top" width="15%" headers="mcps1.1.3.1.1 "><p>400</p>
</td>
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>直播域名删除失败</p>
</td>
</tr>
</tbody>
</table>
