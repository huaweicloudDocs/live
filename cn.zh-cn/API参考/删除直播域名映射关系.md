# 删除直播域名映射关系<a name="DeleteDomainMapping"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=DeleteDomainMapping)中调试该接口。

## URI

DELETE /v1/\{project\_id\}/domains\_mapping
...
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>pull_domain</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.2 "><p>是</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p>String</p>
...
```
DELETE https://{endpoint}/v1/{project_id}/domains_mapping?pull_domain=play.example.huawei.com&push_domain=publish.example.huawei.com
```
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>直播域名映射关系删除成功</p>
</td>
</tr>
<tr><td class="cellrowborder" valign="top" width="15%" headers="mcps1.1.3.1.1 "><p>400</p>
</td>
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>直播域名映射关系删除失败</p>
</td>
</tr>
</tbody>
</table>
