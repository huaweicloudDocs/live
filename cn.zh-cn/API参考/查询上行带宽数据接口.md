# 查询上行带宽数据接口<a name="ShowUpBandwidthV2"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ShowUpBandwidthV2)中调试该接口。

## URI

GET /v2/\{project\_id\}/stats/up-bandwidth/detail
...
```
GET /v2/{project_id}/stats/up-bandwidth?publish_domains=play.example.com&start_time=2020-06-04T07:00:00Z&end_time=2020-06-05T07:00:00Z
