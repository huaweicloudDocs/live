# 查询上行带宽数据接口<a name="ShowUpBandwidth"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ShowUpBandwidth)中调试该接口。
