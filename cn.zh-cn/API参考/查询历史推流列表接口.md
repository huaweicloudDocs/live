# 查询历史推流列表接口<a name="ListHistoryStreamsV2"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListHistoryStreamsV2)中调试该接口。
...
```
GET /v2/{project_id}/history/streams?domain=play.example.com&limit=10&offset=1
