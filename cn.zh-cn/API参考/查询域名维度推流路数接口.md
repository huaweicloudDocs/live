# 查询域名维度推流路数接口<a name="ShowStreamCountV2"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ShowStreamCountV2)中调试该接口。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>推流域名列表，最多支持查询10个域名，多个域名以逗号分隔，若查询多个域名，则返回的是多个域名合并数据。</p>
</td>
</tr>
