# 查询录制规则配置<a name="ShowRecordRule"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ShowRecordRule)中调试该接口。

## URI

GET /v1/\{project\_id\}/record/rules/\{id\}
...
```
{
  ...
  "project_id" : "05a8ae5925000fb72f83c0091083231a",
