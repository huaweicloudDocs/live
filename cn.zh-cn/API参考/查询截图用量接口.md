# 查询截图用量接口<a name="ListSnapshotData"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListSnapshotData)中调试该接口。

## URI

GET /v2/\{project\_id\}/stats/snapshot
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>snapshot_list</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_SnapshotData">SnapshotData</a> objects</p>
</td>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>指定时间区间内截图数量总和</p>
</td>
</tr>
</tbody>
</table>
...
<a name="response_SnapshotData"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.2"><p>参数类型</p>
</th>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>每小时内截图总数，单位为张。</p>
</td>
</tr>
...
```
GET /v2/{project_id}/stats/snapshot?publish_domain=test.huawei.com&start_time=2020-08-18T07:00:00Z&end_time=2020-08-18T08:00:00Z
