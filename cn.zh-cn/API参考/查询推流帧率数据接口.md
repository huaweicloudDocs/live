# 查询推流帧率数据接口<a name="ListSingleStreamFramerate"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListSingleStreamFramerate)中调试该接口。
