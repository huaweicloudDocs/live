# 查询推流码率数据接口<a name="ListSingleStreamBitrate"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListSingleStreamBitrate)中调试该接口。
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>App名。</p>
</td>
</tr>
