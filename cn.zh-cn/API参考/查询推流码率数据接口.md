# 查询推流码率数据接口<a name="ListSingleStreamBitrateV2"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListSingleStreamBitrateV2)中调试该接口，并获取该接口关联的CLI示例：  [hcloud Live ListSingleStreamBitrateV2](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=Live&api=ListSingleStreamBitrateV2)。

## URI

GET /v2/\{project\_id\}/stats/stream/bitrate
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>bitrate_info_list</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_V2BitrateInfo">V2BitrateInfo</a> objects</p>
</td>
...
<a name="response_V2BitrateInfo"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.2"><p>参数类型</p>
</th>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>数据</p>
</td>
</tr>
</tbody>
</table>
...
```
GET /v2/{project_id}/stats/stream/bitrate?app=live&stream=pull_stream&domain=example.huawei.com
