# 查询播放带宽峰值接口<a name="ListDomainBandwidthPeak"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListDomainBandwidthPeak)中调试该接口。
