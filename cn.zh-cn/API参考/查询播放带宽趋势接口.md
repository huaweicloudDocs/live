# 查询播放带宽趋势接口<a name="ListBandwidthDetailV2"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListBandwidthDetailV2)中调试该接口，并获取该接口关联的CLI示例：  [hcloud Live ListBandwidthDetailV2](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=Live&api=ListBandwidthDetailV2)。
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>采样值，单位为bps。</p>
</td>
</tr>
