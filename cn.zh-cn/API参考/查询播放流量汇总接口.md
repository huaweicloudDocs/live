# 查询播放流量汇总接口<a name="ListDomainTrafficSummaryV2"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListDomainTrafficSummaryV2)中调试该接口，并获取该接口关联的CLI示例：  [hcloud Live ListDomainTrafficSummaryV2](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=Live&api=ListDomainTrafficSummaryV2)。
