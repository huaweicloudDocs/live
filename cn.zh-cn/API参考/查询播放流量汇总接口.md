# 查询播放流量汇总接口<a name="ListDomainTrafficSummary"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListDomainTrafficSummary)中调试该接口。
