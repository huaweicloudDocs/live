# 查询播放流量趋势接口<a name="ListDomainTrafficDetailV2"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListDomainTrafficDetailV2)中调试该接口，并获取该接口关联的CLI示例：  [hcloud Live ListDomainTrafficDetailV2](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=Live&api=ListDomainTrafficDetailV2)。

## URI

GET /v2/\{project\_id\}/stats/traffic/detail
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>查询数据的时间粒度。支持300（默认值）, 3600和86400秒。不传值时，使用默认值300秒。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_TrafficData">TrafficData</a> objects</p>
</td>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>采样值，单位为byte。</p>
</td>
</tr>
...
```
GET /v2/{project_id}/stats/traffic/detail?play_domains=test.huawei.com
