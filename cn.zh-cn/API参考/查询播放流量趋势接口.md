...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListDomainTrafficDetailV2)中调试该接口。
...
```
{
  ...
  "error_msg" : "Invalid request parameter: start_time"
}
```
