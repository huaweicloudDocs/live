...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>状态码。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>结束时间。日期格式按照ISO8601表示法，并使用UTC时间。</p>
