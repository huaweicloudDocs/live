...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ShowOnlineUsers)中调试该接口，并获取该接口关联的CLI示例：  [hcloud Live ShowOnlineUsers](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=Live&api=ShowOnlineUsers)。
