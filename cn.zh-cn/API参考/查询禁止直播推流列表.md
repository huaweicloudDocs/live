...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListStreamForbidden)中调试该接口，并获取该接口关联的CLI示例：  [hcloud Live ListStreamForbidden](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=Live&api=ListStreamForbidden)。
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>禁播黑名单列表</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>恢复流时间，格式：yyyy-mm-ddThh:mm:ssZ，UTC时间，不指定则永久禁播</p>
</td>
</tr>
</tbody>
</table>
