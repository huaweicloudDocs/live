# 查询观众趋势接口<a name="ListUsersOfStream"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=ListUsersOfStream)中调试该接口。
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>查询数据的时间粒度，支持60（默认值）, 300秒。不传值时，使用默认值60秒。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>观众趋势列表。</p>
</td>
</tr>
</tbody>
</table>
