...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Live&api=DeleteStreamForbidden)中调试该接口，并获取该接口关联的CLI示例：  [hcloud Live DeleteStreamForbidden](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=Live&api=DeleteStreamForbidden)。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>RTMP应用名称</p>
</td>
</tr>
