...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>恢复流时间，格式：yyyy-mm-ddThh:mm:ssZ，UTC时间，不指定则默认7天，最大禁推为90天</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>设置禁止直播推流操作失败</p>
</td>
</tr>
</tbody>
</table>
