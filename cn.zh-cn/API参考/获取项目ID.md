# 获取项目ID<a name="live_03_0023"></a>

在调用接口的时候，部分URL中需要填入项目ID，所以需要获取到项目ID。您可以通过以下两种方式获取项目ID。

## 从控制台获取项目ID<a name="zh-cn_topic_0171449878_section16150143114253"></a>
...
2.  在基本信息页面单击“管理我的凭证“，进入“我的凭证”页面。
    ...
    **图 1**  基本信息<a name="zh-cn_topic_0171449878_zh-cn_topic_0161541108_fig651815401114"></a>  
...
获取项目ID的接口为“GET https://\{Endpoint\}/v3/projects/”，其中\{Endpoint\}为IAM的终端节点，可以从[地区和终端节点](使用前必读.md#section98151621305)获取。接口的认证鉴权请参见[认证鉴权](认证鉴权.md)。
