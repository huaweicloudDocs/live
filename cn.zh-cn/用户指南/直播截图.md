...
5.  单击“新建截图”，进入截图模板参数配置页面。
    ...
    **表 1**  截图参数配置
    ...
    <td class="cellrowborder" valign="top" width="77.75%" headers="mcps1.2.3.1.2 "><p id="p7176241399"><a name="p7176241399"></a><a name="p7176241399"></a>应用名称，默认为“live”，您也可以根据实际需求进行自定义。</p>
    </td>
    </tr>
