...
5.  单击“新建截图”，进入截图模板参数配置页面。
    ...
    **表 1**  截图参数配置
    ...
    <td class="cellrowborder" valign="top" width="77.75%" headers="mcps1.2.3.1.2 "><p id="p7176241399"><a name="p7176241399"></a><a name="p7176241399"></a>应用名称，默认为“live”，您也可以根据实际需求进行自定义<span id="ph579671911413"><a name="ph579671911413"></a><a name="ph579671911413"></a>，</span><span id="ph3176152013416"><a name="ph3176152013416"></a><a name="ph3176152013416"></a>支持大小写字母、数字、下划线（_）中划线（-）</span>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="77.75%" headers="mcps1.2.3.1.2 "><p id="p1468811556491"><a name="p1468811556491"></a><a name="p1468811556491"></a>在OBS桶存储截图的方式，可选为<strong id="b97471544561"><a name="b97471544561"></a><a name="b97471544561"></a>覆盖截图</strong>或<strong id="b09981414571"><a name="b09981414571"></a><a name="b09981414571"></a>实时截图</strong>。</p>
