...
6.  配置转码参数，参数说明如[表1](#table103061641153118)。
    ...
    **表 1**  转码模板参数说明
    ...
    <td class="cellrowborder" valign="top" width="58.9%" headers="mcps1.2.4.1.3 "><p id="p18305144103115"><a name="p18305144103115"></a><a name="p18305144103115"></a>应用名称，默认为“live”，可以根据实际需求进行自定义。</p>
    </td>
    </tr>
