...
6.  请您按照实际需求配置录制参数，参数说明如[表1](#table1985784519104)所示。
    ...
    **表 1**  录制参数说明
    ...
    <tbody><tr id="row4857184531018"><td class="cellrowborder" valign="top" width="22.21%" headers="mcps1.2.3.1.1 "><p id="p9857204513104"><a name="p9857204513104"></a><a name="p9857204513104"></a>AppName</p>
    </td>
    <td class="cellrowborder" valign="top" width="77.79%" headers="mcps1.2.3.1.2 "><p id="p1185818458105"><a name="p1185818458105"></a><a name="p1185818458105"></a>应用名称，默认为“live”，可以根据实际需求进行自定义。若填写为“*”，则录制规则适用于该域名下的所有应用。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="77.79%" headers="mcps1.2.3.1.2 "><p id="p11858174531018"><a name="p11858174531018"></a><a name="p11858174531018"></a>直播流名称，若需要将录制规则用于该AppName下的所有直播流，则填写为“*”。</p>
    </td>
    </tr>
    ...
    <tr id="row4719142768"><td class="cellrowborder" valign="top" headers="mcps1.2.3.1.1 "><p id="p1378715181897"><a name="p1378715181897"></a><a name="p1378715181897"></a>录制周期：录制时长支持15-180分钟，最大支持录制3小时。超过3小时，系统将按照命名规则生成新文件。</p>
    </td>
    </tr>
    ...
    <tr id="row3230175616419"><td class="cellrowborder" valign="top" headers="mcps1.2.3.1.1 "><p id="p178581345131015"><a name="p178581345131015"></a><a name="p178581345131015"></a>录制周期：录制时长支持15-180分钟，最大支持录制3小时。超过3小时，系统将按照命名规则生成新文件。</p>
    </td>
    </tr>
