...
6.  请您按照实际需求配置录制参数，参数说明如[表1](#table1985784519104)所示。
    ...
    **表 1**  录制参数说明
    ...
    <td class="cellrowborder" valign="top" width="77.79%" headers="mcps1.2.3.1.2 "><p id="p1185818458105"><a name="p1185818458105"></a><a name="p1185818458105"></a>应用名称，默认为“live”，可以根据实际需求进行自定义<span id="ph137251845144012"><a name="ph137251845144012"></a><a name="ph137251845144012"></a>，</span><span id="ph1621124715403"><a name="ph1621124715403"></a><a name="ph1621124715403"></a>支持大小写字母、数字、下划线（_）中划线（-）</span>。若填写为“*”，则录制规则适用于该域名下的所有应用。</p>
    </td>
    </tr>
